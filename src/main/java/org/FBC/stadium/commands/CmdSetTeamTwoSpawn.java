...
import org.FBC.stadium.SetTeamTwoSpawn;
import org.bukkit.Location;
import org.bukkit.entity.Player;

public class CmdSetTeamTwoSpawn {
    private Main plugin;

    public CmdSetTeamTwoSpawn(Player player, String[] args, Main main) {
        this.plugin = main;
        if (args.length <= 0) {
            return;
        }
        ...
        new org.FBC.stadium.SetTeamTwoSpawn(StadName, loc, this.plugin);
    }
}
